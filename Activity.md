...
## 一.正常情况下生命周期如图
![](http://img.blog.csdn.net/20160911182533967)

正常生命周期 开起activity调用onCreate() onStart() onResume(),按下返回键 onPause() onStop() onDestroy()

启动activity onCreate() onStart() onResume()切换到桌面或者打开一个新的activity  onPause() onStop() 返回该activity onRestart() onStart() onResume()
...
![](http://img.blog.csdn.net/20160911183227623)
</br>
</br>
## 二.异常情况生命周期
...
![](http://img.blog.csdn.net/20160911183451573)
...
```
横竖屏切换后,activity并未重启,而是调用了onConfigurationChanged()![](http://img.blog.csdn.net/20160911185143194)                   	                                                                                                                                                                                      
...
![](http://img.blog.csdn.net/20160911185503772)
...
![](http://img.blog.csdn.net/20160911185847215)
...
![](http://img.blog.csdn.net/20160911190035312)
...
![](http://img.blog.csdn.net/20160911190325378)
