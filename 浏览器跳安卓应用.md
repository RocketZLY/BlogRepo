...
![这里写图片描述](http://img.blog.csdn.net/20160512141836352)

在这里他们页面添加了个data-sentintent的标签，看到这里，应该能确定第三方浏览器应该是默认都不支持发intent的，只能自己起一个。根据前端说，这个标签应该是自定义的。我们前端看源码的时候发现是这样的![这里写图片描述](http://img.blog.csdn.net/20160512141916836)
